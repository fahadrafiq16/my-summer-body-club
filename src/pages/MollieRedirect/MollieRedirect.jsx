    ...
    useEffect(() => {
        const fetchPayments = async () => {
            try {
                ...
                // Backend may return an array or Mollie paginated shape { _embedded: { payments: [...] } }
                const list = Array.isArray(response.data)
                    ? response.data
                    : (response.data?._embedded?.payments ?? response.data?.data ?? response.data?.payments ?? []);
                ...
                if (match) {
                    ...
                    try {
                        ...
                        const addUserResponse = await axios.post(`${BASE_BACKEND_URL}/api/add-user`, dataToSend, {
