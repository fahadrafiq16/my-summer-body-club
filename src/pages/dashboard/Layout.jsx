...
import { FiHome, FiCreditCard, FiMessageSquare, FiBarChart2, FiBookOpen, FiLogOut } from "react-icons/fi";
            ...
            <div className="fixed h-screen w-56 min-h-screen bg-[#ef4d16] border border-[#ef4d16] flex flex-col">
                ...
                <div className="dashboard-navigation bg-[#ef4d16] flex-1">
                    <ul>
                        ...
                        <li><Link to="/dashboard/charts" className="block p-2">
                            <FiBarChart2 className="mr-2 text-lg inline-block" />
                            Charts
                        </Link></li>
                        <li><Link to="/dashboard/training-programs" className="block p-2">
                            <FiBookOpen className="mr-2 text-lg inline-block" />
                            Training Programs
                        </Link></li>
                        <li><Link to="/dashboard-new" className="block p-2">
                            <FiBarChart2 className="mr-2 text-lg inline-block" />
                            Dashboard New
                        </Link></li>
                    </ul>
